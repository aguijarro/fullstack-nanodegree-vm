...
CLIENT_ID = json.loads(open('app/mod_auth/client_secrets.json', 'r').read())['web']['client_id']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('app/mod_auth/client_secrets.json', scope='')
